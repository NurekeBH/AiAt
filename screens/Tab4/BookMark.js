...
export default class BookMark extends Component {
    ...
    deleteRow(rowMap, rowKey) {
        AsyncStorage.getItem("token").then((value) => {
            if (value !== null) {
                ...
                axios.post('/api/book/favorite_book', { 'book_id': rowKey.book_id, "type": "delete" }, { headers: { Authorization: AuthStr } })
                    .then(response => {
                        console.log('favorite_book', response.data);
    ...
    loadBookData = () => {
        AsyncStorage.getItem("token").then((value) => {
            if (value !== null) {
                const AuthStr = 'Bearer '.concat(value);
                axios.get('/api/book/users_favorite', { headers: { Authorization: AuthStr } })
                    .then(response => {
